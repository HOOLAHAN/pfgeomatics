    ...
    <Box p={5} maxW="1200px" mx="auto">
      ...
      <SimpleGrid columns={{ sm: 1, md: 2, lg: 3 }} spacing={10}>
        {servicesData.map((service: Service) => (
          <VStack key={service.title} align="stretch" p={5} boxShadow="lg" borderRadius="lg" bg="gray.50">
            <Image borderRadius="md" src={require(`../data/serviceImages/${service.image}`)} alt={`${service.title} image`} boxSize="200px" objectFit="cover" />

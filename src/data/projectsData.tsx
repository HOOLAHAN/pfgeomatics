...
export const projectsData = [
  ...
  },
  {
    ...
    description: "On the 105 Victoria Street project, we provided a comprehensive range of engineering services. These included holding down bolt surveys, embedment plate surveys, and the preparation of fin plate fabrication drawings. Our team carried out the setting out of column packs and the precise positioning of columns for line and level. We also performed setting out for precast planks and delivered detailed As-Built surveys of columns, beams, and precast planks to support quality assurance and design validation.",
    linkedIn: "",
  },
  {
    name: "Tempo Project",
  ...
  },
  {
    ...
    description: "We collaborated with Alpine Group, a steel fabricator subcontractor, on an office refurbishment project. Our team conducted a detailed survey of the existing structure, including the slab, beams, columns, and bathroom pods. We provided an As-Built survey in the form of an AutoCAD drawing, which designers used to size their components to fit the existing structure. In addition, we provided setting out services at the time of installation to ensure accurate positioning of the fabricated elements on site.",
    linkedIn: "",
  },
  {
    name: "Guildford MSCP",
